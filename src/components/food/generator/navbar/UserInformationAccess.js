  ...
  return (
    <div className="bg-color-2 w-[300px] relative color-yellow">
      ...
      <div className="flex row color-1 p-1 h-full relative justify-end">
        <label className="self-center text-lg text-white">
          {user.username}
        </label>
        ...
        {isOpen && (
          <Modal isOpen={isOpen} handleClose={() => setIsOpen(!isOpen)}>
            <div
              className="flex flex-row ustify-center shadow-inner bg-white rounded-lg my-3"
              data-testId="user-informations"
            >
